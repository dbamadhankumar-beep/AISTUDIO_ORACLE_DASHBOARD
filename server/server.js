...
async function startServer() {
  ...
  app.listen(PORT, () => {
    ...
    console.log(`  - POST http://localhost:${PORT}/api/agent/data (for agents)`);
    console.log(`  - GET  http://localhost:${PORT}/api/frontend/data (for dashboard)`);
    console.log(`Frontend will be served from the 'build' directory if it exists.`);
  });
}
